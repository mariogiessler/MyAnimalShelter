...
public class FrameMoveListener implements MouseListener, MouseMotionListener {
    private static int startDistanceX, startDistanceY, mousePositionX, mousePositionY;

    public static FrameMoveListener instance = new FrameMoveListener();

    @Override
    public void mouseDragged(MouseEvent mouseEvent) {
        mousePositionX = (int) mouseEvent.getLocationOnScreen().getX();
        mousePositionY = (int) mouseEvent.getLocationOnScreen().getY();
